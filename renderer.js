...
export class Renderer{
  ...
  enemies(c,game){ for(const e of game.enemies){ c.save(); c.fillStyle=e.color; c.beginPath(); c.arc(e.x,e.y,e.r,0,Math.PI*2); c.fill(); if(e.slow>0){c.strokeStyle='#8ce9ff';c.lineWidth=3;c.beginPath();c.arc(e.x,e.y,e.r+4,0,Math.PI*2);c.stroke()} if(e.poison>0){c.strokeStyle='#76f2aa';c.lineWidth=2;c.beginPath();c.arc(e.x,e.y,e.r+7,0,Math.PI*2);c.stroke()} c.strokeStyle=e.flags.boss?'#fff':e.flags.elite?'#ffd36e':'rgba(0,0,0,.45)'; c.lineWidth=e.flags.boss?4:e.flags.elite?3:2; c.stroke(); const bw=e.r*2, bh=4; c.fillStyle='rgba(0,0,0,.5)'; c.fillRect(e.x-e.r,e.y-e.r-10,bw,bh); c.fillStyle=e.flags.boss?'#ff5d73':e.flags.elite?'#ffd36e':'#76f2aa'; c.fillRect(e.x-e.r,e.y-e.r-10,bw*Math.max(0,e.hp/e.maxHp),bh); c.restore(); } }
